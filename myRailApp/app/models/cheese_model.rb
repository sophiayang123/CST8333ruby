...
# # @author Shuting Yang
# class CheeseModel < ApplicationRecord
#     print "this is model, look"
#     attr_accessor :id, :date, :cases, :deaths, :cases_14_100k, :cases_100k, :name_fr, :name_en
...
#         @cases_14_100k = processAsDecimal(params[:cases_14_100k])
#         @cases_100k = processAsDecimal(params[:cases_100k])
...
#     def to_s
#         '%s %s %s %s %s %s %s %s' % [@id, @date, @cases, @deaths, @cases_14_100k, @cases_100k, @name_en, @name_fr]
#     end
# end
